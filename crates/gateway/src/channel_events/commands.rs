...
pub(super) async fn save_channel_voice(
    state: &Arc<tokio::sync::OnceCell<Arc<GatewayState>>>,
    audio_data: &[u8],
    filename: &str,
...
pub(super) async fn save_channel_attachment(
    state: &Arc<tokio::sync::OnceCell<Arc<GatewayState>>>,
    file_data: &[u8],
    filename: &str,
    reply_to: &ChannelReplyTarget,
...
pub(super) async fn resolve_pending_location(
    state: &Arc<tokio::sync::OnceCell<Arc<GatewayState>>>,
    reply_to: &ChannelReplyTarget,
    latitude: f64,
    longitude: f64,
...
pub(super) async fn dispatch_to_chat_with_attachments(
    state: &Arc<tokio::sync::OnceCell<Arc<GatewayState>>>,
    text: &str,
